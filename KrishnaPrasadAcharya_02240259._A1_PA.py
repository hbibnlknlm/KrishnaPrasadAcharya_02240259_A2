...
def trivia_game():
    ...
    questions = {
        "Science": {
            "What is H2O?": ["Water", "Oxygen", "Hydrogen", "Helium"],
            "Which planet is known as the Red Planet?": ["Mars", "Venus", "Saturn", "Jupiter"]
        },
        "History": {
            "Who was the first President of the USA?": ["George Washington", "Abraham Lincoln", "JFK", "Obama"]
        }
    }
